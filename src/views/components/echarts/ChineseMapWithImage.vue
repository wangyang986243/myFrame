      ...
      this.chartAgeOptions = {
        ...
        series: [
          ...
          },
          {
            ...
            coordinateSystem: "geo",
            // symbol: "pin",
            symbol: "image://" + require("@/assets/images/location.png"),
            symbolSize: [28, 10],
            label: {
              normal: {
                show: true,
                textStyle: {
                  color: echartColor[this.themeColor].labelTextStyle,
                  fontSize: 12,
                },
                formatter(value) {
                  return (
            ...
            // data: this.convertData(this.geoCoordData),
            data: [],
            showEffectOn: "render",
            rippleEffect: {
              brushType: "stroke",
  ...
  watch: {
    ...
    themeColor: {
      handler(val) {
        ...
        this.chartAgeOptions.series[2].label.normal.textStyle.color =
          echartColor[this.themeColor].labelTextStyle;
      },
    },
  },
};
