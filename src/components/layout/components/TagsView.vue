  ...
  <div class="tags-view-container">
    <scroll-pane ref="scrollPane" class="tags-view-wrapper">
      <router-link
        ...
        <span v-show="visitedViews.length > 1" class="el-icon-close" @click.prevent.stop="closeSelectedTag(tag)" />
      </router-link>
    </scroll-pane>
...
.tags-view-container {
  ...
  .tags-view-wrapper {
    ...
    .tags-view-item {
      ...
      // height: 26px;
      line-height: 26px;
      // border: 1px solid rgba(35, 39, 51, 1);
      // color: #D9DAE0;
      // background: rgba(35, 39, 51, 1);
      padding: 0 8px;
      font-size: 12px;
      margin-left: 2px;
      margin-top: 4px;
